...
function createPostPushPutOutput(verb, definitions, pathKeys) {
	...
	try {
		if (verb.parameter) {
			var Parameter = verb.parameter.fields.Parameter;
			for (var i in Parameter) {
				...
				params.push({
					...
					"description": removeTags(o.description),
					"required": !o.optional
				});
			}
		}
	...
	pathItemObject[verb.type] = {
		tags: [verb.group],
		summary: removeTags(verb.description||verb.title),
		consumes: [
			"application/json"
		],
		produces: [
